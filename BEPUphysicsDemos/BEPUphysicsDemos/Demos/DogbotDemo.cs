...
namespace BEPUphysicsDemos.Demos
{
    ...
    public class DogbotDemo : StandardDemo
    {
            ...
            : base(game)
        {
            ...
            head.OrientationMatrix = Matrix3X3.CreateFromAxisAngle(-Vector3.UnitZ, MathHelper.PiOver2);
            Space.Add(head);
            ...
            var angleLimit = new SwingLimit(body, head, Vector3.UnitX, Vector3.UnitX, MathHelper.PiOver4);
            ...
            shoulder.OrientationMatrix = Matrix3X3.CreateFromAxisAngle(Vector3.UnitX, MathHelper.PiOver2);
            Space.Add(shoulder);

            //Connect the shoulder to the body.
            var axisJoint = new RevoluteJoint(body, shoulder, shoulder.Position, -Vector3.UnitZ);
            ...
            axisJoint = new RevoluteJoint(shoulder, arm, shoulder.Position + new Vector3(0, .6f, 0), -Vector3.UnitZ);
            Space.Add(axisJoint);

            //Connect the arm to the body.
            pointOnLineJoint = new PointOnLineJoint(arm, body, arm.Position, Vector3.UnitY, arm.Position + new Vector3(0, -.4f, 0));
            Space.Add(pointOnLineJoint);


            shoulder.OrientationMatrix *= Matrix3X3.CreateFromAxisAngle(-Vector3.UnitZ, MathHelper.Pi); //Force the walker's legs out of phase.
            ...
            //Connect the shoulder to the body.
            axisJoint = new RevoluteJoint(body, shoulder, shoulder.Position, -Vector3.UnitZ);
