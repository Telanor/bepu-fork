...
namespace BEPUphysicsDemos.Demos
{
    ...
    public class UnfortunateGuyDemo : StandardDemo
    {
            ...
            : base(game)
        {
            ...
            var swingLimit = new EllipseSwingLimit(torso, upperArm, Vector3.UnitY, MathHelper.PiOver2, MathHelper.PiOver4 * 3);
            Space.Add(swingLimit);

            //Upper arms can't spin around forever.
            var twistLimit = new TwistLimit(torso, upperArm, Vector3.UnitY, Vector3.UnitY, -MathHelper.PiOver4 / 2, MathHelper.PiOver4);
            ...
            var elbow = new SwivelHingeJoint(upperArm, lowerArm, upperArm.Position + new Vector3(0, .6f, 0), -Vector3.UnitZ);
            ...
            swingLimit = new EllipseSwingLimit(lowerArm, hand, Vector3.UnitY, MathHelper.PiOver4, MathHelper.PiOver2);
            Space.Add(swingLimit);

            //Allow a little extra twist beyond the forearm.
            twistLimit = new TwistLimit(lowerArm, hand, Vector3.UnitY, Vector3.UnitY, -MathHelper.PiOver4 / 2, MathHelper.PiOver4 / 2);
            twistLimit.SpringSettings.StiffnessConstant = 100;
            twistLimit.SpringSettings.DampingConstant = 100;
            Space.Add(twistLimit);
