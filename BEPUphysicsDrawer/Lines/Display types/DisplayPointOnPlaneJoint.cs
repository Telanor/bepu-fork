...
namespace BEPUphysicsDrawer.Lines
{
    ...
    public class DisplayPointOnPlaneJoint : SolverDisplayObject<PointOnPlaneJoint>
    {
        ...
        public override void Update()
        {
            ...
            Vector3 y = MathConverter.Convert(SharpDX.Vector3.Cross(constraint.ConnectionA.OrientationMatrix.Up, constraint.PlaneNormal));
            if (y.LengthSquared() < .001f)
            {
                y = MathConverter.Convert(SharpDX.Vector3.Cross(constraint.ConnectionA.OrientationMatrix.Right, constraint.PlaneNormal));
            }
