...
namespace BEPUphysicsDrawer.Models
{
    ...
    public static class DisplayConvexHull
    {
        ...
        public static void GetShapeMeshData(EntityCollidable collidable, List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            {
                normal = MathConverter.Convert(SharpDX.Vector3.Normalize(SharpDX.Vector3.Cross(hullTriangleVertices[i + 2] - hullTriangleVertices[i], hullTriangleVertices[i + 1] - hullTriangleVertices[i])));
