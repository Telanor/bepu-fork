...
namespace BEPUphysicsDrawer.Models
{
    ...
    public class DisplayWrappedBody
    {
        ...
        public static void GetShapeMeshData(EntityCollidable collidable, List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            SharpDX.Vector3 max;
            var direction = new SharpDX.Vector3();
            ...
            var hullTriangleVertices = new List<SharpDX.Vector3>();
            ...
            {
                Vector3 normal = MathConverter.Convert(SharpDX.Vector3.Normalize(SharpDX.Vector3.Cross(hullTriangleVertices[i + 2] - hullTriangleVertices[i], hullTriangleVertices[i + 1] - hullTriangleVertices[i])));
