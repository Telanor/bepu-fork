...
namespace BEPUphysics.Constraints
{
    ...
    public abstract class EntitySolverUpdateable : SolverUpdateable
    {
        ...
        protected internal virtual void OnInvolvedEntitiesChanged()
        {
            ...
            RawList<Entity> newInvolvedEntities = BEPUphysics.ResourceManagement.Resources.GetEntityRawList();
            ...
            BEPUphysics.ResourceManagement.Resources.GiveBack(newInvolvedEntities);
        }
