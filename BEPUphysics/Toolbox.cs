...
namespace BEPUphysics
{
    ...
    public static class Toolbox
    {
	   ...
	   public static float Epsilon = 1E-7f;
        ...
        /// </summary>
        public static Vector3 BackVector = Vector3.UnitZ;

        /// <summary>
        /// Reference for a vector with dimensions (0,-1,0).
        /// </summary>
        public static Vector3 DownVector = -Vector3.UnitY;
        ...
        /// </summary>
        public static Vector3 LeftVector = -Vector3.UnitX;
        ...
        public static bool IsPointWithinFaceExtrusion(Vector3 point, List<Plane> planes, Vector3 centroid)
        {
            ...
            {
                float centroidPlaneDot = Plane.DotCoordinate(plane, centroid);
                float pointPlaneDot = Plane.DotCoordinate(plane, point);
        ...
        {
            var subsimplexCandidate = BEPUphysics.ResourceManagement.Resources.GetIntList();
            var baryCoordsCandidate = BEPUphysics.ResourceManagement.Resources.GetFloatList();
            ...
            if (!baryCoordsFound)
            {
                ...
                float abcd = (MatrixEx.CreateMatrix(tetrahedron[0].X, tetrahedron[0].Y, tetrahedron[0].Z, 1,
                ...
                float pbcd = (MatrixEx.CreateMatrix(p.X, p.Y, p.Z, 1,
                                         tetrahedron[1].X, tetrahedron[1].Y, tetrahedron[1].Z, 1,
                                         tetrahedron[2].X, tetrahedron[2].Y, tetrahedron[2].Z, 1,
                                         tetrahedron[3].X, tetrahedron[3].Y, tetrahedron[3].Z, 1)).Determinant();
                float apcd = (MatrixEx.CreateMatrix(tetrahedron[0].X, tetrahedron[0].Y, tetrahedron[0].Z, 1,
                                         p.X, p.Y, p.Z, 1,
                                         tetrahedron[2].X, tetrahedron[2].Y, tetrahedron[2].Z, 1,
                                         tetrahedron[3].X, tetrahedron[3].Y, tetrahedron[3].Z, 1)).Determinant();
                float abpd = (MatrixEx.CreateMatrix(tetrahedron[0].X, tetrahedron[0].Y, tetrahedron[0].Z, 1,
                                         tetrahedron[1].X, tetrahedron[1].Y, tetrahedron[1].Z, 1,
                                         p.X, p.Y, p.Z, 1,
                                         tetrahedron[3].X, tetrahedron[3].Y, tetrahedron[3].Z, 1)).Determinant();
                abcd = 1 / abcd;
            ...
            BEPUphysics.ResourceManagement.Resources.GiveBack(subsimplexCandidate);
            BEPUphysics.ResourceManagement.Resources.GiveBack(baryCoordsCandidate);
        }
        ...
        {
            if (sweep.X > 0)
                boundingBox.Maximum.X += sweep.X;
            else
                boundingBox.Minimum.X += sweep.X;

            if (sweep.Y > 0)
                boundingBox.Maximum.Y += sweep.Y;
            else
                boundingBox.Minimum.Y += sweep.Y;

            if (sweep.Z > 0)
                boundingBox.Maximum.Z += sweep.Z;
            else
                boundingBox.Minimum.Z += sweep.Z;
        }
        ...
        public static void GetTriangleBoundingBox(ref Vector3 a, ref Vector3 b, ref Vector3 c, out BoundingBox aabb)
        {
            ...
            if (a.X > b.X && a.X > c.X)
            {
                ...
                aabb.Maximum.X = a.X;
                if (b.X > c.X)
                    aabb.Minimum.X = c.X; //C is min
                else
                    aabb.Minimum.X = b.X; //B is min
            }
            else if (b.X > c.X)
            {
                //B is max
            ...
            if (a.Y > b.Y && a.Y > c.Y)
            {
                ...
                aabb.Maximum.Y = a.Y;
                if (b.Y > c.Y)
                    aabb.Minimum.Y = c.Y; //C is min
                else
                    aabb.Minimum.Y = b.Y; //B is min
            }
            else if (b.Y > c.Y)
            {
                //B is max
            ...
            if (a.Z > b.Z && a.Z > c.Z)
            {
                ...
                aabb.Maximum.Z = a.Z;
                if (b.Z > c.Z)
                    aabb.Minimum.Z = c.Z; //C is min
                else
                    aabb.Minimum.Z = b.Z; //B is min
            }
            else if (b.Z > c.Z)
            {
                //B is max
