...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class CylinderShape : ConvexShape
    {
        ...
        public override void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            boundingBox.Minimum.X = shapeTransform.Position.X - collisionMargin - right.X;
            boundingBox.Minimum.Y = shapeTransform.Position.Y - collisionMargin - up.Y;
            boundingBox.Minimum.Z = shapeTransform.Position.Z - collisionMargin - backward.Z;
        }
