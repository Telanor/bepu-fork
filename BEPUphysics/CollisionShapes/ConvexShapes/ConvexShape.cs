...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        public virtual void GetBoundingBox(ref RigidTransform shapeTransform, out BoundingBox boundingBox)
        {
            ...
            boundingBox.Maximum.X = shapeTransform.Position.X + collisionMargin + right.X;
            boundingBox.Maximum.Y = shapeTransform.Position.Y + collisionMargin + up.Y;
            boundingBox.Maximum.Z = shapeTransform.Position.Z + collisionMargin + backward.Z;

            boundingBox.Minimum.X = shapeTransform.Position.X - collisionMargin + left.X;
            boundingBox.Minimum.Y = shapeTransform.Position.Y - collisionMargin + down.Y;
            boundingBox.Minimum.Z = shapeTransform.Position.Z - collisionMargin + forward.Z;
        ...
        public void GetLocalBoundingBox(ref RigidTransform shapeTransform, ref AffineTransform spaceTransform, out BoundingBox boundingBox)
        {
            ...
            //These right/up/backward represent the extreme points in world space along the world space axes.
            boundingBox.Maximum.X = transform.Translation.X + right.X;
            boundingBox.Maximum.Y = transform.Translation.Y + up.Y;
            boundingBox.Maximum.Z = transform.Translation.Z + backward.Z;

            boundingBox.Minimum.X = transform.Translation.X + left.X;
            boundingBox.Minimum.Y = transform.Translation.Y + down.Y;
            boundingBox.Minimum.Z = transform.Translation.Z + forward.Z;
        }
